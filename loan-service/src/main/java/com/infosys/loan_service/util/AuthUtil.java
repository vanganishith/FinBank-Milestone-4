package com.infosys.loan_service.util;

import com.infosys.loan_service.exception.AccessDeniedException;
import com.infosys.loan_service.feign.AuthFeignClient;
...
public class AuthUtil {
    ...
    public void requireOwnershipOrTeller(String authHeader, Integer ownerCustId) {
        ...
        if ("CUSTOMER".equals(role)) {
            ...
            if (callerCustId == null || !callerCustId.equals(ownerCustId)) {
                throw new AccessDeniedException("Access denied. This is not your loan.");
            }
            return;
        }
    ...
    /** For endpoints where the customer is asking about their OWN custId directly (e.g. /apply, /customer/{custId}). */
    public void requireSelfOrTeller(String authHeader, Integer targetCustId) {
        requireOwnershipOrTeller(authHeader, targetCustId);
    }
